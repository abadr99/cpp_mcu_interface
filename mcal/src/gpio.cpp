...
void Gpio<TPort>::Write() {
    using DL = Gpio<TPort>::DigitalLevel;
    switch (TDigitalVal) {
...
template class Gpio<avr::types::Port::kPortA>::GpioRegisters<avr::types::Port::kPortA>; //IGNORE-STYLE-CHECK[L004]
template class Gpio<avr::types::Port::kPortB>::GpioRegisters<avr::types::Port::kPortB>; //IGNORE-STYLE-CHECK[L004]
template class Gpio<avr::types::Port::kPortC>::GpioRegisters<avr::types::Port::kPortC>; //IGNORE-STYLE-CHECK[L004]
template class Gpio<avr::types::Port::kPortD>::GpioRegisters<avr::types::Port::kPortD>; //IGNORE-STYLE-CHECK[L004]
