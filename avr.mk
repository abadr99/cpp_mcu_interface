...
AVR_GCCFLAGS:=    	 -g -Wall -DF_CPU=$(AVR_CLK) -mmcu=$(AVR_MCU) -gdwarf-2 -O2 -Werror -std=c++17
AVR_OPT_CCFLAGS:= 	 -g -Wall -DF_CPU=$(AVR_CLK) -mmcu=$(AVR_MCU) -gdwarf-2 -O3 -Werror -std=c++17
AVR_GCC_TEST_FLAGS:= -g -Wall -DF_CPU=$(AVR_CLK) -mmcu=$(AVR_MCU) -gdwarf-2 -O2 -Werror -std=c++17
AVR_OBJ_COPY_OPTS:= -j .text -j .data -O ihex 

AVR_TARGET:= avr
AVR_OBJDIR := .build/obj
AVR_OBJS:= $(patsubst %.cpp,$(AVR_OBJDIR)/%.o,$(SRC_NAMES))
